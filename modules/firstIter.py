                    ...
                    async with session.post(getURL, headers=headers) as resp:
                        ...
                        if orgFound:
                            if (found[0]['sid'].upper() == orgSID.upper()):
                                ...
                                embed = discord.Embed(title=message.author.name, colour=discord.Colour(0x00FF00),
                                                      url=correctURL,
                            ...
                            embed = discord.Embed(title=message.author.name, colour=discord.Colour(0xFFFF00),
                                                  url=correctURL,
